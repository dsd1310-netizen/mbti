/**
 * 명리(사주) 핵심 콘텐츠 — 사주 인트로, 카테고리별 해석(성격/커리어/연애/재물), 처방전,
 * 풍수, 대운/세운, 오늘의 나풀이, 오행/궁합 종합 해설, 정밀 궁합, 기둥별 해설.
...
import {
  ...
  callGeminiJsonApi, callGeminiPlainApi,
  CategoryInterpretation, SajuIntro, AiCategoryKey,
} from './core';
